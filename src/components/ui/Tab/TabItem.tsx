...
const TabItem = ({ id: idProp, children, className }: TabItemProps) => {
    ...
    const baseStyle =
        'flex items-center gap-2 px-4 text-sm bg-[var(--background-tinted-base,rgba(0,0,0,0.08))] hover:bg-white hover:text-black';
