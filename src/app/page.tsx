...
export default function Home() {
    return (
        <OverlayScrollbarsComponent options={mainScrollbarOptions} data-id="home" className="h-full rounded-lg relative overflow-hidden overflow-y-auto scroll-smooth bg-[var(--background-base)] overflow-y">
                    ...
                    <section>
                        ...
                        <div className="w-full overflow-hidden overflow-x-auto scroll-smooth snap-x snap-mandatory">
                            <ul className="grid grid-flow-col auto-cols-[195.5px] gap-4 mt-4 pl-6 pr-6">
                                <li>
                                    <Card profile={true} title={cardData01.title} links={cardData01.links} />
                                </li>
                                <li>
                                    <Card profile={true} title={cardData01.title} links={cardData01.links} />
                                </li>
